...
if (process.env.SOUNDCLOUD_USER === null || process.env.SOUNDCLOUD_USER === undefined) exit() 
...
export const getUserInfo = async () => {
  ...
  return await axios.get(`https://api-v2.soundcloud.com/users/${userId}?client_id=${client_id}`)
}
