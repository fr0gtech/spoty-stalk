...
import { selectDurationMS, selectLoadedSongs, selectPlay, selectProgressMS, selectShuffle, selectSongInfo, selectSongToPlay, selectType, setIsSeeking, setPlay, setPlaySetter, setProgressMS, setSeekTo, setShuffle, setSongToPlay } from "../../redux/playerSlice";
...
function Buttons(props:any){
    ...
    const prevSong = useCallback(() => {
      ...
      prev
        ...
        : dispatch(setSongToPlay(loadedSongsMapped[loadedSongsMapped.length - 1]));
